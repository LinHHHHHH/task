...
def get_dv(start = 20170101,end = 20180101): 
    ...
    dataview_folder = r'D:\股票因子数据\data'
...
from Tamplate import BIAS1_1,TVMA201,RSI6_1,BIAS2_1,PEHIST601,BIAS3_1,DDIF2,DIFMA_1,MAADTM_1,MADPO1,MAEMV1,MAVPT_1,MTM_2,MTR_2,PEEH1201

for f in ['BIAS1_1','TVMA201','RSI6_1','BIAS2_1','PEHIST601','BIAS3_1','DDIF2','DIFMA_1','MAADTM_1','MADPO1','MAEMV1','MAVPT_1','MTM_2','MTR_2','PEEH1201']:
